...
/**
 *  Created by yangchaojiang on 2016/9/18.
 * 圆角imageView
 */
public class ShapeImageView extends ImageView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mShapeMode = a.getInt(R.styleable.ShapeImageView_shape_mode, 1);
            mRadius = a.getDimension(R.styleable.ShapeImageView_round_radius, dip2px(getContext(),7));
            a.recycle();
        }
        mPaint = new Paint();
