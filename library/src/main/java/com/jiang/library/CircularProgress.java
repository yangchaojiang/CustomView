...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(android.R.color.holo_red_light);
        mColors[1] = context.getResources().getColor(R.color.color_yellow);
        mColors[2] = context.getResources().getColor(R.color.color_gray);
        mColors[3] = context.getResources().getColor(R.color.color_blue);
